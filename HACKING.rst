...
- Pyright_  (also available via snap: ``snap install shellcheck``)
...
A complete list is kept in our requirements-dev.txt_ file in dev dependencies.
...
.. _requirements-dev.txt: ./requirements-dev.txt
